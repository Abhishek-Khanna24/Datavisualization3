...
const margin = {top: 4, right: 29, bottom: 49, left: 69};
width = 499;
height = 599;
const visWidth = 499 - margin.left - margin.right;
const visHeight = 599 - margin.top - margin.bottom;

//color
color = d3.scaleOrdinal(d3.schemePaired).domain(purpose_array)
legend2(div, color);
